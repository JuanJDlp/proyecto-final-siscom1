...
Este documento consolida los hallazgos del **Análisis Exploratorio de Datos (EDA)** realizado sobre tres datasets agroclimáticos públicos, como parte de la Fase 1 del proyecto de simulación de un sistema IoT para agricultura digital.
...
| Variable | Rango Normal (datos) | Rango Óptimo (Q4) | Alerta Baja | Alerta Alta |
|---|---|---|---|---|
| Temperatura (°C) | 10–45 | 28–35 | < 18 °C | > 38 °C |
| Lluvia mensual (mm) | 800–2000 | 1350–1550 | < 900 mm | > 1900 mm |
| Humedad relativa (%) | 50–90 | 69–75 | < 55% | > 88% |
| pH suelo | 6.0–8.5 | 6.5–7.9 | < 5.5 | > 8.5 |
| Humedad suelo (%) | 10–40 | 25–32 | **< 15%** | > 40% |
| Radiación solar (MJ/m²/d) | 15–30 | 18–26 | < 12 | > 28 |
...
### 9.4 Payload JSON recomendado (Fase 2)
